...
export const USER_GET_PASSWORD_REQUEST = 'USER_GET_PASSWORD_REQUEST';
export const USER_GET_PASSWORD_SUCCESS = 'USER_GET_PASSWORD_SUCCESS';
export const USER_GET_PASSWORD_FAIL = 'USER_GET_PASSWORD_FAIL';
